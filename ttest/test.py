...
class SerialConsole(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.serial_port_dropdown = tk.OptionMenu(self, self.serial_port_var, *[port.device for port in self.serial_ports])
        ...
        self.baud_rate_dropdown = tk.OptionMenu(self, self.baud_rate_var, *self.baud_rates)
        ...
        self.disconnect_button = tk.Button(self, text="Disconnect", command=self.disconnect_serial, state="disabled")
    ...
    def connect_serial(self):
        if self.serial_port is None:
            self.stop_serial = False
            self.serial_port = serial.Serial(self.serial_port_var.get(), self.baud_rate_var.get())
